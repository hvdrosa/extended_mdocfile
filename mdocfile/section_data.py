...
class MdocSectionData(BaseModel):
    ...
    CtfFindAstigmatism: Optional[float]
    CtfFindMeanDefocus: Optional[float]
    CtfFindAstigAxis: Optional[float]
    CtfFindPhaseShift: Optional[float]
    CtfFindFitScore: Optional[float]
    CtfFindResFit: Optional[float]
    @validator(
        'PieceCoordinates',
        'SuperMontCoords',
        'ImageShift',
